...
using TinyEvents.Sample.PostgreSql.EfCore;
...
builder.Services.UsePostgreSqlEntityFrameworkCoreOutbox<SampleDbContext>();
...
namespace TinyEvents.Sample.PostgreSql.EfCore
{
